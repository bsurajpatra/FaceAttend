                            ...
                            {success ? (
                                ...
                                <>
                                    <div className="mb-10 text-center">
                                        ...
                                        <h3 className="text-3xl font-black text-slate-900 mb-2 uppercase tracking-tight">Recover Access</h3>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-6">
                                        ...
                                        <button
                                            type="submit"
                                            disabled={isLoading}
                                            className="w-full flex items-center justify-center gap-3 py-4 px-8 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-black text-sm uppercase tracking-[0.2em] shadow-2xl shadow-blue-200 transition-all active:scale-95"
                                        >
                                            {isLoading ? (
